...
declare module "@salesforce/schema/Product2.Macaron_Flavor__c" {
  const Macaron_Flavor__c:string;
  export default Macaron_Flavor__c;
}
declare module "@salesforce/schema/Product2.Shirt__c" {
  const Shirt__c:string;
  export default Shirt__c;
}
