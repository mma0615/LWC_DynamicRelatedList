...
declare module "@salesforce/schema/Opportunity.Contact_Lookup__r" {
  const Contact_Lookup__r:any;
  export default Contact_Lookup__r;
}
declare module "@salesforce/schema/Opportunity.Contact_Lookup__c" {
  const Contact_Lookup__c:any;
  export default Contact_Lookup__c;
}
declare module "@salesforce/schema/Opportunity.Bear_Lookup__r" {
  const Bear_Lookup__r:any;
  export default Bear_Lookup__r;
}
declare module "@salesforce/schema/Opportunity.Bear_Lookup__c" {
  const Bear_Lookup__c:any;
  export default Bear_Lookup__c;
}
